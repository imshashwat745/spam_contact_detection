...
from app.interactors.search_info_by_name_interactor import SearchInfoByNameInteractor
...
@api_view(["GET"])
def search_info_by_name(request) -> Response:
    ...
    interactor = SearchInfoByNameInteractor()
